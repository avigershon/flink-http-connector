...
| gid.connector.http.sink.proxy.host                      | optional | Specify the hostname of the proxy. |
| gid.connector.http.sink.proxy.port                      | optional | Specify the port of the proxy. |
| gid.connector.http.sink.proxy.username                  | optional | Specify the username used for proxy authentication. |
| gid.connector.http.sink.proxy.password                  | optional | Specify the password used for proxy authentication. |
